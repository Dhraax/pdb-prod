...
This module defines project-wide conventions for new and materially refactored
NWScript code.
...
| Document | Purpose |
|----------|---------|
| [Style guide](style-guide.md) | Required headers, function layout, documentation, naming, formatting, and API reference policy |
