...
int CnrGetTradeskillXPByType(object oPC, int nTradeskillType)
{
    ...
    return CnrGetPersistentInt(oContainer, "CnrTradeskillXP_"+IntToString(nTradeskillType));
}
...
void CnrSetTradeskillXPByType(object oPC, int nTradeskillType, int nXP)
{
    ...
    CnrSetPersistentInt(oContainer, "CnrTradeskillXP_"+IntToString(nTradeskillType), nXP);
}
...
void CnrRecipeDisplayCraftingResult(object oPC, object oDevice, string sKeyToRecipe, int bSuccess, string sResult, int nEffDC, location locPCAtStart, int bWithConvo)
{
  ...
  if (bSuccess)
  {
    ...
    int nScaledGameXP = FloatToInt((IntToFloat(nEffDC-1) / 7.0) * IntToFloat(nGameXP));
    int nScaledTradeXP = FloatToInt((IntToFloat(nEffDC-1) / 7.0) * IntToFloat(nTradeXP));
...
int CnrRecipeAttemptToCraft(object oPC, object oDevice, int nRecipeIndex, int bWithConvo)
{
  ...
  else
  {
    ...
    DelayCommand(0.5, ExecuteScript(sScript, oDevice));
    if (sScript == "")
    {
