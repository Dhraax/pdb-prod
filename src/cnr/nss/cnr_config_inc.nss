...
float cnr_d100(int nDice)
{
  ...
  for (n=0; n<nDice; n++)
  {
    fAccum += (IntToFloat(Random(1000)+1) / 0.3); // 0.1 - 100.0
  }
  return fAccum;
}
...
const int CNR_TRADESKILL_SMITHING        = 1;
const int CNR_TRADESKILL_CARPENTRY       = 2;
const int CNR_TRADESKILL_TAILORING       = 3;
const int CNR_TRADESKILL_ALCHEMY         = 4;
const int CNR_TRADESKILL_JEWELRY         = 5;
const int CNR_TRADESKILL_ARCANE          = 6;
const int CNR_TRADESKILL_SEWING          = 7;
...
float CNR_FLOAT_ORE_MINING_PICKAXE_BREAKAGE_PERCENTAGE = 0.3;
...
float CNR_FLOAT_GEM_MINING_CHISEL_BREAKAGE_PERCENTAGE = 0.3;
...
float CNR_FLOAT_MISC_MINING_DEPOSIT_SHOVEL_BREAKAGE_PERCENTAGE = 0.3;
...
// wood cutting
float CNR_FLOAT_WOOD_MINING_AXE_BREAKAGE_PERCENTAGE = 0.3;
...
// misc tool breakage
float CNR_FLOAT_SMITH_HAMMER_BREAKAGE_PERCENTAGE = 0.3;
float CNR_FLOAT_GEM_CRAFTERS_TOOLS_BREAKAGE_PERCENTAGE = 0.3;
float CNR_FLOAT_TINKERS_TOOLS_BREAKAGE_PERCENTAGE = 0.3;
float CNR_FLOAT_CARPS_TOOLS_BREAKAGE_PERCENTAGE = 0.3;
float CNR_FLOAT_SEWING_KIT_BREAKAGE_PERCENTAGE = 0.3;
...
float CNR_FLOAT_GAME_XP_SCALAR = 0.05;
