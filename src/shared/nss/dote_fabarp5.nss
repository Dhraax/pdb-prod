//::///////////////////////////////////////////////
//:: FABRICAR OBJETO DE ARPISTA (flauta de pan)
//:: Copyright (c) www.puertadebladur.net
//:://////////////////////////////////////////////
/*
    Crea 1 flauta de pan magica.
*/
//:://////////////////////////////////////////////
//:: Created By: Monti
...
void main()
{
  ...
  // Ajustes objeto
  FloatingTextStringOnCreature("* Creas una flauta de pan mágica *", oPC);
  ...
  object oObjetoCreado = CreateItemOnObject("zep_pipes", oPC);
  DelayCommand(1.0, SetName(oObjetoCreado, "Flauta de pan mágica de " + GetName(oPC)));
  DelayCommand(1.0, SetDescription(oObjetoCreado, "Esta flauta de pan mágica la creó " + GetName(oPC) + " gracias a sus habilidades como arpista. Es mágica y contiene un poderoso hechizo mágico que puede descargarse."));
