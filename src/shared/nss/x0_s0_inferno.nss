...
void RunImpact(object oTarget, object oCaster, int nMetamagic, int nSpellId = 446);
...
SetLocalInt(OBJECT_SELF, "X2_L_LAST_SPELLSCHOOL_VAR", SPELL_SCHOOL_EVOCATION);
    ...
    if(!MyResistSpell(OBJECT_SELF, oTarget))
    {
        ...
        DelayCommand(fDelay+0.1f,RunImpact(oTarget, oSelf,nMetaMagic, GetSpellId()));
    }
    else
    {
        //----------------------------------------------------------------------
...
void RunImpact(object oTarget, object oCaster, int nMetaMagic, int nSpellId = 446)
{
    ...
    if (GetIsDead(oTarget) == FALSE)
    {
        ...
        DelayCommand(6.0f,RunImpact(oTarget,oCaster,nMetaMagic, nSpellId));
    }
}
