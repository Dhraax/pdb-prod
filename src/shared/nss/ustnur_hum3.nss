...
void main()
{
  ...
  else TakeGoldFromCreature(150, oPC, TRUE);
...
CreateObject(OBJECT_TYPE_CREATURE,"nur_hum",loc,FALSE,"sacrificio");
...
if(i1 == 1)
{
DelayCommand(10.0,AssignCommand(oSacri,SpeakString("¡Oh no!¡Nooooooo!¡No me puedo mover!")));
}
else if(i1 == 2)
{
DelayCommand(10.0,AssignCommand(oSacri,SpeakString("¡Por los Nueve Infiernos! ¿Es otro de vuestros trucos?")));
}
else if(i1 == 2)
{
DelayCommand(10.0,AssignCommand(oSacri,SpeakString("¿¡Que sucia artimaña es esta!?")));
}
else
{
...
if(i3 == 1)
{
DelayCommand(12.0,AssignCommand(GetNearestObjectByTag("nur_espectador2"),SpeakString("¡El traidor te dará tu merecido, asqueroso rivvin!")));
}
else if(i3 == 2)
{
