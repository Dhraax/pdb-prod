...
FloatingTextStringOnCreature("¡Te ha tocado un premio!", oPC);
...
if(!GetLocalInt(OBJECT_SELF, "bGameComplete")){SendMessageToPC(oPC, "¡Espera a que acabe la tirada para empezar otra ronda!"); return;}
...
if(iGold)
    ...
    DelayCommand(4.0, SendMessageToPC(oPC, "¡¡Has ganado "  + IntToString(iWin) + " po!!"));
