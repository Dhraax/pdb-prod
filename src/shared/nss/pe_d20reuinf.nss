void main()
{
  // Bono dote soltura
  int iBono = 0;
  if(GetHasFeat(1246, GetPCSpeaker())) iBono = 10;      // Soltura epica
  else if(GetHasFeat(1234, GetPCSpeaker())) iBono = 3;  // Soltura normal

  string sTirada = "Reunir información";
  int iDado = Random(20)+1;
  int iRangos = GetSkillRank(35, GetPCSpeaker()) + iBono;
