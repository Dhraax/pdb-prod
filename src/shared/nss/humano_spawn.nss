void main()
{
   ...
   SetLocalString(oContenedor, "Res","humano");
   SetLocalString(oContenedor, "Raza","NW_CREATURE_001");
   location lSpawn = GetLocation(GetWaypointByTag("spawn_creatura"));
//   effect eVis = EffectVisualEffect(VFX_IMP_HEAD_ODD);
//   effect ePetrify = EffectParalyze();
   CreateObject(OBJECT_TYPE_CREATURE, "humano", lSpawn, FALSE);
   object oTarget = GetObjectByTag("NW_CREATURE_001");
...
//   DelayCommand(1.0,ApplyEffectToObject(DURATION_TYPE_PERMANENT, ePetrify, oTarget));
