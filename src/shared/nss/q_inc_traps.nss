...
/*
    *General Notes*
    ...
    To use these scripts in your module you need to uncomment this line in the
    Project Q default OnModuleLoad Event (q_mod_def_load.nss), located at line
    8 in the script:
    ...
    OR, if using a custom OnModuleLoad Event, add this line to your
