void main()
{
  // Bono dote soltura
  int iBono = 0;
  if(GetHasFeat(1239, GetPCSpeaker())) iBono = 10;     // Soltura epica
  else if(GetHasFeat(1222, GetPCSpeaker())) iBono = 3; // Soltura normal

  string sTirada = "Averiguar intenciones";
  int iDado = Random(20)+1;
  int iRangos = GetSkillRank(28, GetPCSpeaker()) + iBono;
