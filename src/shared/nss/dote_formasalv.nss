//::///////////////////////////////////////////////
//:: DOTE FORMA SALVAJE AMPLIADA
//:: Copyright (c) www.puertadebladur.net
//:://////////////////////////////////////////////
/*
    Forma salvaje ampliada.
*/
//:://////////////////////////////////////////////
//:: Created By: Monti
//:: Created On: 24 de Octubre de 2011
//:://////////////////////////////////////////////
...
void main()
{
  ...
  {
      // Si no te quedan usos de Forma Salvaje, nanay
      if(GetLevelByClass(51)>0){
        //Asolador
        if(!GetHasFeat(1402)) {
            FloatingTextStringOnCreature("<cþ<<>No te quedan usos diarios de forma salvaje muerta viviente!</c>", OBJECT_SELF, FALSE);
            return;
        }
        AssignCommand(oPC, ClearAllActions(TRUE));
        SetLocalInt(oPC, "TIPO_POLIMORFACION", 1);
        AssignCommand(oPC, ActionStartConversation(oPC, "dote_poliformas", TRUE, FALSE));
          ...
          if(GetHasFeat(FEAT_GREATER_WILDSHAPE_1) == FALSE &&
             ...
             GetHasFeat(FEAT_WILD_SHAPE) == FALSE)
          {
              FloatingTextStringOnCreature("<cþ<<>¡No te quedan usos de Forma Salvaje o Forma Salvaje Mayor!</c>", OBJECT_SELF, FALSE);
              return;
          }
