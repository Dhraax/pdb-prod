...
// End of Spell Cast Hook
    ...
    if(!GetIsReactionTypeFriendly(oTarget))
    {
        ...
        SignalEvent(oTarget, EventSpellCastAt(oTarget, SPELL_BESTOW_CURSE));
         ...
         {
            //Make Will Save
            if (!/*Will Save*/ MySavingThrow(SAVING_THROW_WILL, oTarget, GetWarlockSpellDC(OBJECT_SELF)))
            {
          ...
          ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eAttack, oTarget, HoursToSeconds(1));
