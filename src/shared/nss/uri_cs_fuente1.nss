...
SendMessageToPC (oPC, "*Sientes un tremendo malestar al acercarte al Árbol de la Vida.*");
...
effect eRegenerate = EffectRegenerate (1, 1.0);
SendMessageToPC (oPC, "*Sientes gran bienestar al acercarte al Árbol de la Vida.*");
