void main()
{
  // Bono dote soltura
  int iBono = 0;
  if(GetHasFeat(1247, GetPCSpeaker())) iBono = 10;      // Soltura epica
  else if(GetHasFeat(1235, GetPCSpeaker())) iBono = 3;  // Soltura normal

  string sTirada = "Supervivencia";
  int iDado = Random(20)+1;
  int iRangos = GetSkillRank(36, GetPCSpeaker()) + iBono;
