...
SetLocalInt(OBJECT_SELF, "X2_L_LAST_SPELLSCHOOL_VAR", SPELL_SCHOOL_TRANSMUTATION);
    ...
    */
    ...
    itemproperty ipCastSpell = ItemPropertyOnHitCastSpell(142,GetTotalCasterLevel(OBJECT_SELF));
    itemproperty ipVisual = ItemPropertyVisualEffect(ITEM_VISUAL_HOLY);
    ipBono = TagItemProperty(ipBono, "Arma_Feerica_BonoAtaque");
    ipCastSpell = TagItemProperty(ipCastSpell, "Arma_Feerica_CastSpell");
    ipVisual = TagItemProperty(ipVisual, "Arma_Feerica_Visual");
