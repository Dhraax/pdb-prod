void main()
{
  ...
  object oSalida = GetObjectByTag("salida_hab_noble_vv");
  ...
  location lVampira = GetLocation(GetWaypointByTag("vampira_hab_noble_vv"));

  if(d100() > 90 && sSubraza != "vampiro" && sSubraza != "ghul" && GetIsObjectValid(oAliadoVampis) == FALSE)
  {
