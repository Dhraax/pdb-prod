...
int GetCreatureDiseaseDC(int checkType)
{
    ...
    if (checkType == DISEASE_CHECK_CONE)
    {
        ...
        if (PB_Race_GetIsUndead(OBJECT_SELF)) {
            if(nHD <= 3)
            {
    ...
    if (PB_Race_GetIsUndead(OBJECT_SELF)) return 12;
                ...
                if (!nTempResult)
                {
                    ...
                    case HENCH_AREA_CHECK_HORRID:
                        nTempResult = GetRacialType(oTestTarget) == RACIAL_TYPE_CONSTRUCT ||
                            PB_Race_GetIsUndead(oTestTarget);
                        break;
                    ...
                    case HENCH_AREA_CHECK_NEGLEVEL:
                        nTempResult = PB_Race_GetIsUndead(oTestTarget) ?
                    ...
                    case HENCH_AREA_CHECK_DROWN:
                        {
                            ...
                            nTempResult = nRacialType == RACIAL_TYPE_CONSTRUCT || PB_Race_GetIsUndead(oTestTarget) || nRacialType == RACIAL_TYPE_ELEMENTAL;
                        }
                        break;
...
int GetBestUndeadBuff(int buffSelf, int buffOthers, int nLastSpellCast)
{
    ...
    for (; curCount < nMaxCount; curCount++)
    {
        ...
        if (PB_Race_GetIsUndead(oHenchBuffTarget) &&
...
void HenchSummonFamiliar(object oTarget)
{
    ...
    if (nGoodEvil == ALIGNMENT_NEUTRAL && PB_Race_GetIsUndead(OBJECT_SELF))
    {
...
//$INSERTIONPOINTSTART
        ...
        {
            if (nLastSpellCast != SPELL_CONTROL_UNDEAD && allowDominate && nRange <= 8.0 && useAttackSpells && !GetIsImmune(oTarget, IMMUNITY_TYPE_DOMINATE, OBJECT_SELF) && CheckSpellSaves(oTarget, 7, HENCH_CHECK_SR_WILL_SAVE) && PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_DROWN && nRange <= 8.0 && useAttackSpells && CheckSpellSaves(oTarget, 6, HENCH_CHECK_SR_FORT_SAVE) && nRacialType != RACIAL_TYPE_CONSTRUCT && !PB_Race_GetIsUndead(oTarget) && nRacialType != RACIAL_TYPE_ELEMENTAL)
            {
        ...
        {
            bFoundSpellGlobal = TRUE;
            if (nLastSpellCast != SPELLABILITY_PM_UNDEAD_GRAFT_1 && nRange <= 4.0 && allowAttackAbilities && !(GetIsImmune(oTarget, IMMUNITY_TYPE_MIND_SPELLS, OBJECT_SELF) || GetIsImmune(oTarget, IMMUNITY_TYPE_PARALYSIS, OBJECT_SELF)) && !GetIsDisabled(oTarget) && GetFortitudeSavingThrow(oTarget) <= 14 + GetLevelByClass(CLASS_TYPE_PALEMASTER)/2 + nMySpellCasterDCAdjust && !PB_Race_GetIsElf(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_HARM && nRange <= 4.0 && useAttackSpells && CheckSpellSaves(oTarget, 6, HENCH_CHECK_SR_NO_SAVE) && !PB_Race_GetIsUndead(oTarget) && GetCurrentHitPoints(oTarget) >= 70)
            {
        ...
        {
            if (nLastSpellCast != SPELL_HEAL && nRange <= 4.0 && useAttackSpells && CheckSpellSaves(oTarget, 6, HENCH_CHECK_SR_NO_SAVE) && PB_Race_GetIsUndead(oTarget) && GetCurrentHitPoints(oTarget) >= 70)
            {
        ...
        {
            if (nLastSpellCast != SPELL_CURE_CRITICAL_WOUNDS && nRange <= 4.0 && useAttackSpells && CheckSpellSaves(oTarget, 4, HENCH_CHECK_SR_NO_SAVE) && PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            bFoundSpellGlobal = TRUE;
            if (nLastSpellCast != FEAT_INFLICT_CRITICAL_WOUNDS && nRange <= 4.0 && allowAttackAbilities && !PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_INFLICT_CRITICAL_WOUNDS && nRange <= 4.0 && useAttackSpells && CheckSpellSaves(oTarget, 4, HENCH_CHECK_SR_NO_SAVE) && !PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_VAMPIRIC_TOUCH && nRange <= 4.0 && useAttackSpells && CheckSpellSaves(oTarget, 3, HENCH_CHECK_SR_NO_SAVE) && !GetHasEffect(EFFECT_TYPE_TEMPORARY_HITPOINTS, OBJECT_SELF) && !PB_Race_GetIsUndead(oTarget) && nRacialType != RACIAL_TYPE_CONSTRUCT)
            {
        ...
        {
            if (nLastSpellCast != SPELL_HEALING_STING && nRange <= 4.0 && useAttackSpells && CheckSpellSaves(oTarget, 3, HENCH_CHECK_SR_FORT_SAVE) && !PB_Race_GetIsUndead(oTarget) && nRacialType != RACIAL_TYPE_CONSTRUCT   )
            {
        ...
        {
            if (nLastSpellCast != SPELL_CURE_SERIOUS_WOUNDS && nRange <= 4.0 && useAttackSpells && CheckSpellSaves(oTarget, 3, HENCH_CHECK_SR_NO_SAVE) && PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            bFoundSpellGlobal = TRUE;
            if (nLastSpellCast != FEAT_INFLICT_SERIOUS_WOUNDS && nRange <= 4.0 && allowAttackAbilities && !PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_INFLICT_SERIOUS_WOUNDS && nRange <= 4.0 && useAttackSpells && CheckSpellSaves(oTarget, 3, HENCH_CHECK_SR_NO_SAVE) && !PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_SEARING_LIGHT && nRange <= 20.0 && useAttackSpells && CheckSpellSaves(oTarget, 3, HENCH_CHECK_SR_NO_SAVE) && (PB_Race_GetIsUndead(oTarget) || nRacialType == RACIAL_TYPE_CONSTRUCT))
            {
        ...
        {
            if (nLastSpellCast != SPELL_CURE_MODERATE_WOUNDS && nRange <= 4.0 && allowWeakOffSpells && CheckSpellSaves(oTarget, 2, HENCH_CHECK_SR_NO_SAVE) && PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_INFLICT_MODERATE_WOUNDS && nRange <= 4.0 && allowWeakOffSpells && CheckSpellSaves(oTarget, 2, HENCH_CHECK_SR_NO_SAVE) && !PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            bFoundSpellGlobal = TRUE;
            if (nLastSpellCast != SPELL_HENCH_EyeballRay1 && nRange <= 20.0 && allowUnlimitedAttackAbilities && !PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_CURE_LIGHT_WOUNDS && nRange <= 4.0 && allowWeakOffSpells && CheckSpellSaves(oTarget, 1, HENCH_CHECK_SR_NO_SAVE) && PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_INFLICT_LIGHT_WOUNDS && nRange <= 4.0 && allowWeakOffSpells && CheckSpellSaves(oTarget, 1, HENCH_CHECK_SR_NO_SAVE) && !PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_CURE_MINOR_WOUNDS && nRange <= 4.0 && allowWeakOffSpells && CheckSpellSaves(oTarget, 0, HENCH_CHECK_SR_NO_SAVE) && PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_INFLICT_MINOR_WOUNDS && nRange <= 4.0 && allowWeakOffSpells && CheckSpellSaves(oTarget, 0, HENCH_CHECK_SR_NO_SAVE) && !PB_Race_GetIsUndead(oTarget))
            {
        ...
        {
            if (nLastSpellCast != SPELL_NEGATIVE_ENERGY_RAY && nRange <= 20.0 && allowWeakOffSpells && CheckSpellSaves(oTarget, 1, HENCH_CHECK_SR_NO_SAVE) && !PB_Race_GetIsUndead(oTarget))
            {
...
int HenchUseGrenade(object oTarget)
{
    ...
    if (distance <= 20.0)
    {
        ...
        if (GetHasFixedSpell(SPELL_GRENADE_HOLY) && PB_Race_GetIsUndead(oTarget))
        {
