...
int dmw_conv_Start(int nCurrent, int nChoice, string sParams = "")
{
   ...
   switch(nCurrent)
   {
      case 0:
         nCurrent = 0;
         sText =       "Bienvenido a la 'Varita del Servidor': Podrás ejecutar acciones simples a cualquier jugador.";
         sCall =       "";
         sCallParams = "";
         break;
      ...
      case 2:
         ...
         if(dmwand_istargetpcnme())
         {
            sText =       "Despingüinear este jugador.";
            sCall =       "func_Untoad";
            sCallParams = "";
            break;
         }
      ...
      case 4:
         ...
         {
            sText =       "Listar todos los jugadores.";
      ...
      case 5:
         ...
         if(dmwand_istargetpcnme())
         {
            sText =       "Saltar este jugador a mi localización.";
      ...
      case 6:
         ...
         if(dmwand_istargetpcnme())
         {
            sText =       "Saltarme a la localización de este jugador.";
      ...
      case 7:
         ...
         if(dmwand_istargetpcnme())
         {
            sText =       "Saltar este grupo a mi localización.";
...
void DMFI_toad(object oTarget, object oUser)
{
              ...
              SendMessageToPC(oUser, "Pinwu?  No querras decir.... inutil?");
...
void dmwand_KickPC(object oTarget, object oUser)
{
   ...
   SendMessageToAllDMs (GetName(oTarget, TRUE) + " Ha sido Kickeado.  PJ CD KEY: " + GetPCPublicCDKey(oTarget) + " PJ IP : " + GetPCIPAddress(oTarget));
   PrintString(GetName(oTarget, TRUE) + " fue expulsado.  PC CD KEY: " + GetPCPublicCDKey(oTarget) + " PJ IP : " + GetPCIPAddress(oTarget));
   ...
   switch(nCurrent)
   {
      ...
      default:
         ...
         else
         {
            ...
            sText =       GetName(oPlayer, TRUE) + " (" + GetPCPlayerName(oPlayer) + ")";
            sCall =       sFunc;
