void main()
{
   ...
   SetLocalString(oContenedor, "Raza","NW_CREATURE_006");
   SetLocalString(oContenedor, "Res","gigante");
   location lSpawn = GetLocation(GetWaypointByTag("spawn_creatura"));
//   effect eVis = EffectVisualEffect(VFX_IMP_HEAD_ODD);
//   effect ePetrify = EffectParalyze();
   CreateObject(OBJECT_TYPE_CREATURE, "gigante", lSpawn, FALSE);
   object oTarget = GetObjectByTag("NW_CREATURE_006");
