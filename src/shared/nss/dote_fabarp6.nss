//::///////////////////////////////////////////////
//:: FABRICAR OBJETO DE ARPISTA (trompeta)
//:: Copyright (c) www.puertadebladur.net
//:://////////////////////////////////////////////
/*
    Crea 1 trompeta magica.
*/
//:://////////////////////////////////////////////
//:: Created By: Monti
...
void main()
{
  ...
  // Ajustes objeto
  FloatingTextStringOnCreature("* Creas una trompeta mágica *", oPC);
  ...
  object oObjetoCreado = CreateItemOnObject("pb_trompeta", oPC);
  DelayCommand(1.0, SetName(oObjetoCreado, "Trompeta mágica de " + GetName(oPC)));
  DelayCommand(1.0, SetDescription(oObjetoCreado, "Esta trompeta mágica la creó " + GetName(oPC) + " gracias a sus habilidades como arpista. Es mágica y contiene un poderoso hechizo mágico que puede descargarse."));
  DelayCommand(1.2, EncantamientoPropiedadLanzarConjuro(oObjetoCreado, iRango));
  DelayCommand(1.2, EncantamientoPropiedadBonificadorHabilidad(oObjetoCreado, iRango, 11));
