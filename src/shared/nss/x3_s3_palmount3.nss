...
void main()
{
  ...
  {
      DelayCommand(1.0,IncrementRemainingFeatUses(oPC,1732));
  ...
  if(iMontado > 0)
  {
      ...
      else
      {
          ...
          if(iAparienciaNuevaPJ == 2 || iAparienciaNuevaPJ == 3) sMontura = "cab_huargoconvo"; // Poni de guerra
          else sMontura = "cab_cabnegrconvo"; // Caballo de guerra pesado
  ...
  if(iAparienciaPJ == 2 || iAparienciaPJ == 3) sMontura = "cab_huargoconvo"; // Poni de guerra
  else sMontura = "cab_cabnegrconvo"; // Caballo de guerra pesado
  object oMontura = CreateObject(OBJECT_TYPE_CREATURE, sMontura, GetLocation(oPC));
