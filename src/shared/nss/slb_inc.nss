//::///////////////////////////////////////////////
//:: Name:  slb_inc - Sistema limpiador de basura
//::///////////////////////////////////////////////
/*
...
void SLB_LimpiarSuelo(object oArea)
{

/* bypass if currently in-progress (blocked) or ClearTrash is disabled */
if ((GetLocalInt(oArea, "CT_IN_PROGRESS") != 1) &&
     (GetLocalInt(GetModule(), "CT_DISABLED") != 1))
{

    SetLocalInt(oArea, "CT_IN_PROGRESS", 1); /* set a flag to block */

    int iItemDestructTime;
    int iObjectType;

    int iObjectsDestroyed = 0;
    int iObjectsToDestroy = 50;  /* adjust as desired */
    ...
    SetLocalInt(oArea, "CT_IN_PROGRESS", 0);  /* done, release */
