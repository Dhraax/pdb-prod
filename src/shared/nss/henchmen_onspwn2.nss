//:://////////////////////////////////////////////////
//:: henchmen_onspawn
//:: Script para el onspwn de los ayudantes (drows)
//:://////////////////////////////////////////////////
...
void main()
{
    // EFECTO VISUAL DE DOMINADO
    effect eDominado = SupernaturalEffect(EffectVisualEffect(VFX_DUR_MIND_AFFECTING_DOMINATED));
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, eDominado, OBJECT_SELF);
