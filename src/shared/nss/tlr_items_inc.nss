...
void RemakeCloak(object oNPC, object oItem, int nMode)
{
    ...
    if (GetIsObjectValid(oNew))
    {
        ...
        SendMessageToPC(oPC, "Nueva apariencia: " + IntToString(nCurrApp) +" "+ Get2DAString("cloakmodel", "LABEL", nCurrApp));
}
...
///////////////////////////////////////////////////////////////////
    ...
    if (GetIsObjectValid(oNew))
    {
        ...
        object oPC = GetPCSpeaker();
        SendMessageToPC(oPC, "Nueva apariencia: " + IntToString(nCurrApp));
}
...
void ColorItem(object oNPC, object oItem, int nPart, int nMode)
{
    ...
    if (GetIsObjectValid(oNew))
    {
        ...
        object oPC = GetPCSpeaker();
        SendMessageToPC(oPC, "Nuevo color: " + IntToString(nCurrApp));
