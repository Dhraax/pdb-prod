...
void main()
{
  ...
  SetLocalInt(oPC, "REZARUMBERLI", 1);
  DelayCommand(1440.0, DeleteLocalInt(oPC, "REZARUMBERLI"));
  ...
  if(iProb <= 25 + iSab)
  {
      ...
      DelayCommand(20.0, FloatingTextStringOnCreature("*¡Umberli te ha bendecido!*", oPC, FALSE));
      GiveXPToCreature(oPC,100);
  }
  else
  {
      DelayCommand(20.0, FloatingTextStringOnCreature("*Tus rezos no han llegado a Umberli.*", oPC, FALSE));
