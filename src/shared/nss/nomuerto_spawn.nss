void main()
{
   ...
   SetLocalString(oContenedor, "Res","nomuerto");
   SetLocalString(oContenedor, "Raza","NW_CREATURE_008");
   location lSpawn = GetLocation(GetWaypointByTag("spawn_creatura"));
//   effect eVis = EffectVisualEffect(VFX_IMP_HEAD_ODD);
//   effect ePetrify = EffectPetrify();
   CreateObject(OBJECT_TYPE_CREATURE, "nomuerto", lSpawn, FALSE);
   object oTarget = GetObjectByTag("NW_CREATURE_008");
