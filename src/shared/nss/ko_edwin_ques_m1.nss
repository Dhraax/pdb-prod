...
if((nComprobarQuestLyretha == 2)&&(nComprobarQuestHayla == 2)&&(nComprobarEntrega == 4)&&(nComprobarLegalidad == 4)) return TRUE; //Comprobamos que hizo las quest de Hayla y Lyretha y Laura bien hechas
