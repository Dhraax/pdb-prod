...
void CrearBasura(object oObjetivo, int iRango, int iTienda = FALSE)
{
  ...
  switch(Random(181)+1)
  {
      ...
      case 181: sResref = "rec_marroquineri"; break; // Receta de marroquinerÌaa
