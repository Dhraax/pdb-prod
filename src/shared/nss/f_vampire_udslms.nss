//::///////////////////////////////////////////////
//:: Undead Slime: Associate: On Spawn In
//:: Originally: NW_CH_AC9
...
void main()
{
    ...
    effect eGrease = SupernaturalEffect(EffectAreaOfEffect(AOE_PER_GREASE, "****", "****", "****"));
    effect eDoom = SupernaturalEffect(EffectVisualEffect(VFX_DUR_FLIES));
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, eGrease, OBJECT_SELF);
