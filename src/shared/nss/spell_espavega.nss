...
// End of Spell Cast Hook
   ...
   object oTarget = GetSpellTargetObject();
    ...
    itemproperty ipCastSpell = ItemPropertyOnHitCastSpell(146,GetTotalCasterLevel(OBJECT_SELF));
    itemproperty ipVisual = ItemPropertyVisualEffect(48); // FireBlack
    itemproperty ipRC = ItemPropertyBonusSpellResistance(IP_CONST_SPELLRESISTANCEBONUS_16);
    ipBono = TagItemProperty(ipBono, "Espada_Vengadora_BonoAtaque");
    ipCastSpell = TagItemProperty(ipCastSpell, "Espada_Vengadora_CastSpell");
    ipVisual = TagItemProperty(ipVisual, "Espada_Vengadora_Visual");
    ipRC = TagItemProperty(ipRC, "Espada_Vengadora_RC");
