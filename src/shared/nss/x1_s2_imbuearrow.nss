...
void main()
{
    SendMessageToPC(OBJECT_SELF, "<cþþþ>Recuerda que la habilidad 'Imbuir flecha' la tenemos ampliada en nuestro servidor. Puedes seguir usando esta habilidad, pero también podrás imbuir flechas con un repertorio mayor de conjuros (no sólo bolas de fuego) tantas veces como quieras al día. Para lograr esto, lanza el conjuro que desees sobre una flecha y así la encantarás, pero ten presente que no todos los conjuros se pueden imbuir. Para más información consulta en nuestra web.</c>");
