...
if(GetIsPlayableRacialType(oPC) == TRUE)
    ...
    if(GetPhenoType(oPC) == PHENOTYPE_BIG)
        {
    DelayCommand(15.0,AssignCommand(oPC,SpeakString("Prrfprfprpf *flatulencias* ")));


    DelayCommand(25.0,AssignCommand(oPC,SpeakString("Ugg...¡Qué gases!")));
    ...
    DelayCommand(41.0,AssignCommand(oPC,SpeakString("¡Noto como que encojo!")));
    ...
    DelayCommand(43.0,SetPhenoType(PHENOTYPE_NORMAL,oPC));
