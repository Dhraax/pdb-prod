...
SetLocalInt(OBJECT_SELF, "X2_L_LAST_SPELLSCHOOL_VAR", SPELL_SCHOOL_TRANSMUTATION);
    ...
    */
    ...
    itemproperty ipCastSpell = ItemPropertyOnHitCastSpell(143,GetTotalCasterLevel(OBJECT_SELF));
    itemproperty ipVisual = ItemPropertyVisualEffect(9);//DarkShadow
    ipBono = TagItemProperty(ipBono, "Arma_Cazadora_BonoAtaque");
    ipCastSpell = TagItemProperty(ipCastSpell, "Arma_Cazadora_CastSpell");
    ipVisual = TagItemProperty(ipVisual, "Arma_Cazadora_Visual");
