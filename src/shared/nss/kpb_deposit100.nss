...
if (nBalance>=6000000) { SpeakString("Lo siento no puedes ingresar más oro en tu cámara de depósitos. No cabe ni una sola pieza más. Gracias.", TALKVOLUME_TALK);}
 else
 {
    ...
    if (nGold >= 100)
        ...
        SpeakString("Actualmente tienes " + IntToString(nBalance) + " po guardadas en nuestra caja fuerte.", TALKVOLUME_TALK);
        ...
        //////VARGATH, CANTIDAD DE ORO AL LOG/////
         ...
         string sGold = IntToString(FloatToInt((1.0 -fComi) * IntToFloat(nDeposit)));//"100";
         if (iDif ==0)
         {
