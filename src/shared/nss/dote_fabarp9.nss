//::///////////////////////////////////////////////
//:: FABRICAR OBJETO DE ARPISTA (pocion de gracia felina mayor)
//:: Copyright (c) www.puertadebladur.net
//:://////////////////////////////////////////////
/*
    Crea 1 pocion de gracia felina mayor.
*/
//:://////////////////////////////////////////////
//:: Created By: Monti
...
void main()
{
  ...
  // Ajustes objeto
  FloatingTextStringOnCreature("* Creas una poción de Gracia Felina *", oPC);
  ...
  object oObjetoCreado = CreateItemOnObject("nw_it_mpotion014", oPC);
  DelayCommand(1.0, SetName(oObjetoCreado, "Poción de Gracia Felina"));
  DelayCommand(1.0, SetDescription(oObjetoCreado, "Esta poción de Gracia Felina la creó " + GetName(oPC) + " gracias a sus habilidades como arpista."));
  DelayCommand(1.0, IPRemoveAllItemProperties(oObjetoCreado, DURATION_TYPE_PERMANENT));
  DelayCommand(1.2, EncantamientoPociones(oObjetoCreado, 2));
