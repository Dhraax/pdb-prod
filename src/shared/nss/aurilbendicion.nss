...
string sMensaje6 = "Necesitas " + IntToString(iOro) + " monedas de oro para"
...
string sMensaje4 = "Has donado " + IntToString(iOro) + " monedas de oro al templo";
string sMensaje1 = "Auril te ha transmitido su poder";
string sMensaje3 = "Has recibido un 50% de immunidad al frío";
...
effect eEfecto1 = EffectDamageImmunityIncrease(DAMAGE_TYPE_COLD, 50);
effect eEfecto2 = EffectVisualEffect(VFX_DUR_GLOBE_INVULNERABILITY);
