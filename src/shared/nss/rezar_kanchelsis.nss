...
void main()
{
  ...
  SetLocalInt(oPC, "REZARKANCHELSIS", 1);
  DelayCommand(2000.0, DeleteLocalInt(oPC, "REZARKANCHELSIS"));
  ...
  if(iProb <= 25 + iSab)
  {
      ...
      DelayCommand(20.0, FloatingTextStringOnCreature("*¡Kanchelsis ha recibido tus plegarias!*", oPC, FALSE));
      GiveXPToCreature(oPC,100);
      return;
  }
  else
  {
      DelayCommand(20.0, FloatingTextStringOnCreature("*Tus rezos no han llegado a Kanchelsis.*", oPC, FALSE));
