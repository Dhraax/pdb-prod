void main()
{
   ...
   SetLocalString(oContenedor, "Res","orco");
   SetLocalString(oContenedor, "Raza","NW_CREATURE_002");
   location lSpawn = GetLocation(GetWaypointByTag("spawn_creatura"));
//   effect eVis = EffectVisualEffect(VFX_IMP_HEAD_ODD);
//   effect ePetrify = EffectParalyze();
   CreateObject(OBJECT_TYPE_CREATURE, "orco", lSpawn, FALSE);
   object oTarget = GetObjectByTag("NW_CREATURE_002");
