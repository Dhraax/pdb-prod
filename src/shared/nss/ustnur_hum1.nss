...
if(i1 == 1)
{
DelayCommand(6.0,AssignCommand(oSacri,SpeakString("¿Dónde estoy? ¡Sacadme de aquí!")));
}
else if(i1 == 2)
{
...
{
DelayCommand(13.0,AssignCommand(GetNearestObjectByTag("nur_espectador1"),SpeakString("¡Muerte al rivvin!")));
}
else
{
...
{
DelayCommand(9.0,AssignCommand(GetNearestObjectByTag("nur_espectador2"),SpeakString("¡Veamos qué tiene dentro el rivvin!")));
}
else
{
