...
// End of Spell Cast Hook
    ...
    int nAmount = GetTotalCasterLevel(OBJECT_SELF);
...
int iExtra = 0;
    ...
    if(oItm == OBJECT_INVALID && GetItemPossessedBy(OBJECT_SELF, "raizmolida")!= OBJECT_INVALID)
        {
        iExtra = 20;
        SendMessageToPC(OBJECT_SELF,ColorToken(33,33,180) + "!El conjuro parece haberse potenciado con la raíz molida!");
