//::///////////////////////////////////////////////
//:: FABRICAR OBJETO DE ARPISTA (pocion de Aguante mayor)
//:: Copyright (c) www.puertadebladur.net
//:://////////////////////////////////////////////
/*
    Crea 1 pocion de Aguante mayor.
*/
//:://////////////////////////////////////////////
//:: Created By: Monti
...
void main()
{
  ...
  // Ajustes objeto
  FloatingTextStringOnCreature("* Creas una poción de Aguante *", oPC);
  ...
  object oObjetoCreado = CreateItemOnObject("nw_it_mpotion013", oPC);
  DelayCommand(1.0, SetName(oObjetoCreado, "Poción de Aguante"));
  DelayCommand(1.0, SetDescription(oObjetoCreado, "Esta poción de Aguante la creó " + GetName(oPC) + " gracias a sus habilidades como arpista."));
  DelayCommand(1.0, IPRemoveAllItemProperties(oObjetoCreado, DURATION_TYPE_PERMANENT));
  DelayCommand(1.2, EncantamientoPociones(oObjetoCreado, 3));
