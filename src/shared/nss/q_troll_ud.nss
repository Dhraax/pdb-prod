// Troll OnUserDefined Event
//:://////////////////////////////////////////////
/*
    Damage script for trolls, making them un-killable by anything
    except fire or acid.

    Converted from NWN2 (gb_troll_dmg.nss)
*/
//:://////////////////////////////////////////////
//:: Created By: DBR
//:: Created On: 6/1/06
//:: Updated: DBR 7/12/06 - bugfix, made sure the damaged event fires even if down to 1HP.
//:: Updated: MDiekmann 6/28/07 - Added command to clear combat round flag so trolls will attack players after resurrecting.
//:: Updated: Pstemarie 2/6/10 - Converted to NWN, implemented as an OnUserDefined Event.
//:://////////////////////////////////////////////
...
void TrollRessurect()
{
       ...
       SetLocalInt(OBJECT_SELF, "X2_L_MUTEXCOMBATROUND", FALSE);
...
void main()
{
    if (GetModuleSwitchValue(MODULE_SWITCH_HARDCORE_TROLLS) == TRUE)
    {
        ...
        if(nUser == 1006) //DAMAGED
        {
            ...
            //fire trolls immune to fire, but vulnerable to cold
            if (GetAppearanceType(OBJECT_SELF) == 1254)
            {
