...
// End of Spell Cast Hook
    ...
    while(GetIsObjectValid(oTarget))
    {
        ...
        {
            if(GetHasSpellEffect(996, oTarget)) SendMessageToPC(OBJECT_SELF, ColorToken(254,60,60)+GetName(oTarget)+" no puede obtener los beneficios de 'Enemigo eterno de la muerte viviente' al tener el conjuro 'Cuerpo férreo' activo.</c>");
            else
            {
