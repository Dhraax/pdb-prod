...
void RunInfestImpact(object oTarget, object oCaster, int nSaveDC, int nMetaMagic, int nSpellId = SPELL_INFESTATION_OF_MAGGOTS);
      ...
      if (nTouch > 0)
      {
        ...
        if(MyResistSpell(OBJECT_SELF, oTarget, fDelay) == 0)
        {
           ...
           //---------------------------------------------------------------
            ...
            DelayCommand(fDelay+0.1f, RunInfestImpact(oTarget,oCaster,nDC, nMetaMagic, nSpellId));
        }
      }
    }
}
    ...
    if (GetIsDead(oTarget) == FALSE)
    {
         ...
         if (!MySavingThrow(SAVING_THROW_FORT,oTarget,nSaveDC,SAVING_THROW_TYPE_DISEASE,OBJECT_SELF))
         {
            ...
            else
            {
                 ...
                 DelayCommand(6.0, RunInfestImpact(oTarget,oCaster,nSaveDC, nMetaMagic, nSpellId));
            }
