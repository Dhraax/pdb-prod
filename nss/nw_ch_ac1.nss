...
//    TestSpells3();
  ...
  NoSkillStackOnEquip(OBJECT_SELF, oObjetoEquipado);
  NoAbilityStackOnEquip(OBJECT_SELF, oObjetoEquipado);
  NoSavingThrowStackOnEquip(OBJECT_SELF, oObjetoEquipado);
  NoRegStackOnEquip(OBJECT_SELF, oObjetoEquipado, 1);
