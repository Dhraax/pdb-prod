//::///////////////////////////////////////////////
//:: FABRICAR OBJETO DE ARPISTA (pocion de Astucia de Zorro mayor)
//:: Copyright (c) www.puertadebladur.net
//:://////////////////////////////////////////////
/*
    Crea 1 pocion de Astucia de Zorro mayor.
*/
//:://////////////////////////////////////////////
//:: Created By: Monti
...
void main()
{
  ...
  // Ajustes objeto
  FloatingTextStringOnCreature("* Creas una poción de Astucia de Zorro *", oPC);
  ...
  object oObjetoCreado = CreateItemOnObject("nw_it_mpotion017", oPC);
  DelayCommand(1.0, SetName(oObjetoCreado, "Poción de Astucia de Zorro"));
  DelayCommand(1.0, SetDescription(oObjetoCreado, "Esta poción de Astucia de Zorro la creó " + GetName(oPC) + " gracias a sus habilidades como arpista."));
  DelayCommand(1.0, IPRemoveAllItemProperties(oObjetoCreado, DURATION_TYPE_PERMANENT));
  DelayCommand(1.2, EncantamientoPociones(oObjetoCreado, 4));
