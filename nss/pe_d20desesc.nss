void main()
{
  // Bono dote soltura
  int iBono = 0;
  if(GetHasFeat(1240, GetPCSpeaker())) iBono = 10;      // Soltura epica
  else if(GetHasFeat(1224, GetPCSpeaker())) iBono = 3;  // Soltura normal

  string sTirada = "Descifrar escritura";
  int iDado = Random(20)+1;
  int iRangos = GetSkillRank(29, GetPCSpeaker());
