void main()
{
    ...
    string sTirada = "Carisma";                                         //Tipo de tirada, este texto aparecera en la frase que dice el personaje
    int iDado = Random(20)+1;                                           // Dado que se tira, a esto hay que sumarle los rangos
    int iRangos = GetAbilityModifier(ABILITY_CHARISMA, GetPCSpeaker());         // Rangos de la criatura que activa la bolsa de dados
