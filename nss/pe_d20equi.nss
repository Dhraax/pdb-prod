void main()
{
  // Bono dote soltura
  int iBono = 0;
  if(GetHasFeat(1242, GetPCSpeaker())) iBono = 10;      // Soltura epica
  else if(GetHasFeat(1227, GetPCSpeaker())) iBono = 3;  // Soltura normal

  string sTirada = "Equilibrio";
  int iDado = Random(20)+1;
  int iRangos = GetSkillRank(31, GetPCSpeaker()) + iBono;
