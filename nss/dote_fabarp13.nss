//::///////////////////////////////////////////////
//:: FABRICAR OBJETO DE ARPISTA (pocion de Esplendor del Águila mayor)
//:: Copyright (c) www.puertadebladur.net
//:://////////////////////////////////////////////
/*
    Crea 1 pocion de Esplendor del Águila mayor.
*/
//:://////////////////////////////////////////////
//:: Created By: Monti
...
void main()
{
  ...
  // Ajustes objeto
  FloatingTextStringOnCreature("* Creas una poción de Esplendor del Águila *", oPC);
  ...
  object oObjetoCreado = CreateItemOnObject("nw_it_mpotion010", oPC);
  DelayCommand(1.0, SetName(oObjetoCreado, "Poción de Esplendor del Águila"));
  DelayCommand(1.0, SetDescription(oObjetoCreado, "Esta poción de Esplendor del Águila la creó " + GetName(oPC) + " gracias a sus habilidades como arpista."));
  DelayCommand(1.0, IPRemoveAllItemProperties(oObjetoCreado, DURATION_TYPE_PERMANENT));
  DelayCommand(1.2, EncantamientoPociones(oObjetoCreado, 6));
