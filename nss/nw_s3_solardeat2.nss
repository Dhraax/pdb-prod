...
//:://////////////////////////////////////////////
/*
    Explosion divina al morir
    Este script no dara experiencia al ser de un convocado
*/
//:://////////////////////////////////////////////
    ...
    while (GetIsObjectValid(oTarget))
    {
       //Fire cast spell at event for the specified target
        ...
        if (!MyResistSpell(OBJECT_SELF, oTarget, fDelay))
        {
            ...
            nDamage = GetReflexAdjustedDamage(50, oTarget, GetSpellSaveDC(), SAVING_THROW_TYPE_DIVINE);
