...
void main()
{
    ...
    AssignCommand(oPnjCaido, SpeakString("<c!}þ>*El cuerpo abatido por "+sNombreJugador+" comienza a contorsionarse entre convulsiones y espasmos, mientras va mutando hasta convertirse en una criatura lobuna*</c>"));
