//::///////////////////////////////////////////////
//:: FABRICAR OBJETO DE ARPISTA (harpa)
...
void main()
{
  ...
  // Ajustes objeto
  FloatingTextStringOnCreature("* Creas una harpa mágica *", oPC);
  ...
  object oObjetoCreado = CreateItemOnObject("zep_harp", oPC);
  DelayCommand(1.0, SetName(oObjetoCreado, "Harpa mágica de " + GetName(oPC)));
  DelayCommand(1.0, SetDescription(oObjetoCreado, "Esta harpa mágica la creó " + GetName(oPC) + " gracias a sus habilidades como arpista. Es mágica y contiene un poderoso hechizo mágico que puede descargarse."));
