...
SetLocalString(OBJECT_SELF, "Pay1", "ORCO --- ---");
SetLocalString(OBJECT_SELF, "Pay2", "TRASGO TRASGO TRASGO");
SetLocalString(OBJECT_SELF, "Pay3", "ORCO ORCO ---");
SetLocalString(OBJECT_SELF, "Pay4", "ORCO ORCO ORCO");
SetLocalString(OBJECT_SELF, "Pay5", "MINOTAURO MINOTAURO MINOTAURO");
SetLocalString(OBJECT_SELF, "Pay6", "SÚCCUBO SÚCCUBO SÚCCUBO");
SetLocalString(OBJECT_SELF, "Pay7", "CABALLERO CABALLERO CABALLERO");
