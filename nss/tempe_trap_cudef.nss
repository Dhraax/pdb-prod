...
void main()
{
 ...
 location lLoc = GetLocation(oPJ);
    ...
    effect eTerr = EffectVisualEffect(VFX_FNF_SWINGING_BLADE);
    ...
    FloatingTextStringOnCreature("*Al activar el mecanismo oculto, multitud de cuchillas se deslizan hacia ti*", oPJ);
...
object oTarget = GetFirstObjectInShape(SHAPE_SPHERE, 20.0, GetLocation(oPJ), TRUE, OBJECT_TYPE_CREATURE);
    ...
    while(GetIsObjectValid(oTarget))
    {
        ...
        {
            eMal = EffectDamage(d10(4), DAMAGE_TYPE_SLASHING);
