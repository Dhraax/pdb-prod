void main()
{
  // Bono dote soltura
  int iBono = 0;
  if(GetHasFeat(1245, GetPCSpeaker())) iBono = 10;      // Soltura epica
  else if(GetHasFeat(1233, GetPCSpeaker())) iBono = 3;  // Soltura normal

  string sTirada = "Hablar un idioma";
  int iDado = Random(20)+1;
  int iRangos = GetSkillRank(34, GetPCSpeaker()) + iBono;
