...
// * if not runnning normal or better Ai then exit for performance reasons
   ...
   //Lanzamos los conjuros primero
   //Aplicamos conjuros cuando ve a un enemigo
    int sTipoEncuentro = GetLocalInt(GetArea(OBJECT_SELF), "TIPO_ENCUENTRO");
    int sEncuentro = GetLocalInt(GetArea(OBJECT_SELF), "NIVEL_ENCUENTRO");
    int nClass = GetLocalInt(OBJECT_SELF, "ENC_CLASS");
    int nPowers = GetLocalInt(OBJECT_SELF, "CONJAPLICADOS");
    if(nClass == CLASS_TYPE_WIZARD && nPowers == 0) {
            switch(sEncuentro) {
                                case 0:
                                        ActionCastSpellAtObject(SPELL_MAGE_ARMOR, OBJECT_SELF, METAMAGIC_ANY, TRUE, 4, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        SetLocalInt(OBJECT_SELF, "CONJAPLICADOS", 1);
                                        break;
                                case 1:
                                        ActionCastSpellAtObject(SPELL_MAGE_ARMOR, OBJECT_SELF, METAMAGIC_ANY, TRUE, 8, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ActionCastSpellAtObject(SPELL_INVISIBILITY, OBJECT_SELF, METAMAGIC_ANY, TRUE, 8, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ActionCastSpellAtObject(SPELL_HASTE, OBJECT_SELF, METAMAGIC_ANY, TRUE, 8, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        SetLocalInt(OBJECT_SELF, "CONJAPLICADOS", 1);
                                        break;
                                case 2:
                                        ActionCastSpellAtObject(SPELL_MAGE_ARMOR, OBJECT_SELF, METAMAGIC_ANY, TRUE,12, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ActionCastSpellAtObject(SPELL_IMPROVED_INVISIBILITY, OBJECT_SELF, METAMAGIC_ANY, TRUE, 12, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ActionCastSpellAtObject(SPELL_HASTE, OBJECT_SELF, METAMAGIC_ANY, TRUE, 12, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ActionCastSpellAtObject(SPELL_DEATH_ARMOR, OBJECT_SELF, METAMAGIC_ANY, TRUE, 12, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        SetLocalInt(OBJECT_SELF, "CONJAPLICADOS", 1);
                                        break;
                                case 3:
                                        ActionCastSpellAtObject(SPELL_MAGE_ARMOR, OBJECT_SELF, METAMAGIC_ANY, TRUE, 16, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ActionCastSpellAtObject(SPELL_IMPROVED_INVISIBILITY, OBJECT_SELF, METAMAGIC_ANY, TRUE, 16, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ActionCastSpellAtObject(SPELL_HASTE, OBJECT_SELF, METAMAGIC_ANY, TRUE, 16, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ActionCastSpellAtObject(SPELL_DEATH_ARMOR, OBJECT_SELF, METAMAGIC_ANY, TRUE, 16, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ActionCastSpellAtObject(SPELL_SEE_INVISIBILITY, OBJECT_SELF, METAMAGIC_ANY, TRUE, 16, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        SetLocalInt(OBJECT_SELF, "CONJAPLICADOS", 1);
                                        break;
                                case 4:;
                                        ActionCastSpellAtObject(SPELL_MAGE_ARMOR, OBJECT_SELF, METAMAGIC_ANY, TRUE, 16, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ...
                                        ActionCastSpellAtObject(SPELL_DEATH_ARMOR, OBJECT_SELF, METAMAGIC_ANY, TRUE, 16, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ActionCastSpellAtObject(SPELL_SEE_INVISIBILITY, OBJECT_SELF, METAMAGIC_ANY, TRUE, 16, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        ActionCastSpellAtObject(SPELL_GLOBE_OF_INVULNERABILITY, OBJECT_SELF, METAMAGIC_ANY, TRUE, 16, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
                                        SetLocalInt(OBJECT_SELF, "CONJAPLICADOS", 1);
                                        break;
                                }
