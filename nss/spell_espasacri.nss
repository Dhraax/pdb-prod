...
// End of Spell Cast Hook
   ...
   object oTarget = GetSpellTargetObject();
    ...
    itemproperty ipCastSpell = ItemPropertyOnHitCastSpell(147,GetTotalCasterLevel(OBJECT_SELF));
    ...
    ipBono = TagItemProperty(ipBono, "Espada_Sacrilega_BonoAtaque");
    ipCastSpell = TagItemProperty(ipCastSpell, "Espada_Sacrilega_CastSpell");
    ipVisual = TagItemProperty(ipVisual, "Espada_Sacrilega_Visual");
    ipRC = TagItemProperty(ipRC, "Espada_Sacrilega_RC");
