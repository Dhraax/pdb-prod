...
object oPuta = GetObjectByTag("puta_esmel_bg");
object oTarget = GetWaypointByTag("bg_p_mujer_entrada");
object oMod = GetModule();
DelayCommand(0.5, TakeGoldFromCreature(100, oPC));
DelayCommand(1.0, SetLocalInt(oMod, "ESTAR_CON_MUJER", 1));
...
DelayCommand(5.0, FloatingTextStringOnCreature("*La mujer te mira con cara de seducción y sonríe picarona*", oPC));
