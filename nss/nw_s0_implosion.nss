...
// End of Spell Cast Hook
    ...
    while (GetIsObjectValid(oTarget) && nCount != 5)
    {
        if (/*oTarget != OBJECT_SELF && */spellsIsTarget(oTarget, SPELL_TARGET_SELECTIVEHOSTILE, OBJECT_SELF)&&(GetCreatureFlag(oTarget, CREATURE_VAR_IS_INCORPOREAL) != TRUE))
        {
