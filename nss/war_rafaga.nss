...
// End of Spell Cast Hook
    ...
    int nDamage = GetLevelByClass(57, oCaster);
    float fDelay;
    ...
    while (GetIsObjectValid(oTarget))
    {
        ...
        if (spellsIsTarget(oTarget, SPELL_TARGET_STANDARDHOSTILE, OBJECT_SELF))
        {
                ...
                if(!MyResistSpell(OBJECT_SELF, oTarget) && !/*Fort Save*/ MySavingThrow(SAVING_THROW_FORT, oTarget, GetWarlockSpellDC(OBJECT_SELF)))
                {
