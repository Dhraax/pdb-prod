//::///////////////////////////////////////////////
//:: FABRICAR OBJETO DE ARPISTA (pandereta)
//:: Copyright (c) www.puertadebladur.net
//:://////////////////////////////////////////////
/*
    Crea 1 pandereta magica.
*/
//:://////////////////////////////////////////////
//:: Created By: Monti
...
void main()
{
  ...
  // Ajustes objeto
  FloatingTextStringOnCreature("* Creas una pandereta mágica *", oPC);
  ...
  object oObjetoCreado = CreateItemOnObject("zep_tambourine", oPC);
  DelayCommand(1.0, SetName(oObjetoCreado, "Pandereta mágica de " + GetName(oPC)));
  DelayCommand(1.0, SetDescription(oObjetoCreado, "Esta pandereta mágica la creó " + GetName(oPC) + " gracias a sus habilidades como arpista. Es mágica y contiene un poderoso hechizo mágico que puede descargarse."));
