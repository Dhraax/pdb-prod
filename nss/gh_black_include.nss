...
void ShowHandAndScores(int DealerNotHidden) {
    SetLocalInt(OBJECT_SELF, "Mano del jugador", GetScore("PLAYER"));
    SetLocalInt(OBJECT_SELF, "Mano del crupier", GetScore("DEALER"));
    ...
    string PlayerHand = "Mano del jugador: " + CardName(GetLocalInt(OBJECT_SELF, "PLAYER_CARD_1")) + ", " + CardName(GetLocalInt(OBJECT_SELF, "PLAYER_CARD_2"));
    string DealerHand;
    if(DealerNotHidden == TRUE) { //hide Dealers first card.
        DealerHand = "Mano del crupier: " + CardName(GetLocalInt(OBJECT_SELF, "DEALER_CARD_1")) + ", " + CardName(GetLocalInt(OBJECT_SELF, "DEALER_CARD_2"));
    }
    else {
        DealerHand = "Mano del jugador: " + "HIDDEN" + ", " + CardName(GetLocalInt(OBJECT_SELF, "DEALER_CARD_2"));
    }
