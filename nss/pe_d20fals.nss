void main()
{
  // Bono dote soltura
  int iBono = 0;
  if(GetHasFeat(1244, GetPCSpeaker())) iBono = 10;      // Soltura epica
  else if(GetHasFeat(1232, GetPCSpeaker())) iBono = 3;  // Soltura normal

  string sTirada = "Falsificar";
  int iDado = Random(20)+1;
  int iRangos = GetSkillRank(33, GetPCSpeaker()) + iBono;
