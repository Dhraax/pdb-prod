...
// End of Spell Cast Hook
    ...
    {
        SendMessageToPC(OBJECT_SELF, ColorToken(254,60,60) +GetName(oTarget)+" no puede obtener los beneficios de 'Libertad de movimiento' al tener el conjuro 'Cuerpo fï¿½rreo' activo.</c>");
        return;
    }
