...
string SPCS_WAYPOINT = "caja_fuerte_pers";  // Tag of a waypoint created at a location in the module to determine the spawn point of the NULL_HUMAN
...
string CofreID = GetTag(OBJECT_SELF);

//::////////////////////////////////////////////////////////////////////////:://
/*DERECHOS DE ALMACENAMIENTO*/
int iDerechos = GetCampaignInt("kpb_bank", "KPB_BANK_RENTAL", oPC);
if(iDerechos == 0)
    {
     SendMessageToPC(oPC, "¡Debes de comprar los derechos de almacenamiento para poder usar la caja fuerte persistente! Contacta con un banquero.");
     return;
    }
//::////////////////////////////////////////////////////////////////////////:://
...
if (GetLocalInt(OBJECT_SELF, "in_use") == 1)
    {
    FloatingTextStringOnCreature("*La caja fuerte no se encuentra disponible ahora, alguien ya la está usando. Intentalo de nuevo cuando acabe*", oPC);
    return;
    }
...
// the chest contents.
object oSpawn = RetrieveCampaignObject(SPCS_DB, CofreID, GetLocation(GetWaypointByTag(SPCS_WAYPOINT)));
...
if (GetItemPossessedBy(oPC,"Llavecofrearcania") != OBJECT_INVALID)
{
object oChest = CreateObject(OBJECT_TYPE_PLACEABLE, "cofre_persistent", GetLocation(OBJECT_SELF));
