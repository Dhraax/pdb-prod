...
void main()
{
  ...
  SetLocalInt(oPC, "REZAISTISHIA", 1);
  DelayCommand(1440.0, DeleteLocalInt(oPC, "REZAISTISHIA"));
  ...
  if(iProb <= 25 + iSab)
  {
      effect eEfecto1 = EffectDamageResistance(DAMAGE_TYPE_ELECTRICAL, 10, 100);
      ...
      DelayCommand(20.0, FloatingTextStringOnCreature("*¡Istishia te ha bendecido!*", oPC, FALSE));
      GiveXPToCreature(oPC,100);
  }
  else
  {
      DelayCommand(20.0, FloatingTextStringOnCreature("*Tus rezos no han llegado a Istishia.*", oPC, FALSE));
