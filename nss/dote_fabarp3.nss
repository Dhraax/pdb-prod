//::///////////////////////////////////////////////
//:: FABRICAR OBJETO DE ARPISTA (violin)
//:: Copyright (c) www.puertadebladur.net
//:://////////////////////////////////////////////
/*
    Crea 1 violin magico.
*/
//:://////////////////////////////////////////////
//:: Created By: Monti
...
void main()
{
  ...
  // Ajustes objeto
  string sResrefViolin;
  if(GetGender(oPC) == GENDER_FEMALE) sResrefViolin = "zep_violinf";
  else sResrefViolin = "zep_violinm";

  FloatingTextStringOnCreature("* Creas un violín mágico *", oPC);
  ...
  object oObjetoCreado = CreateItemOnObject(sResrefViolin, oPC);
  object oObjetoCreado2 = CreateItemOnObject("zep_violinbow", oPC);
  DelayCommand(1.0, SetName(oObjetoCreado, "Violín mágico de " + GetName(oPC)));
  DelayCommand(1.0, SetDescription(oObjetoCreado, "Este violín mágico la creó " + GetName(oPC) + " gracias a sus habilidades como arpista. Es mágico y contiene un poderoso hechizo mágico que puede descargarse."));
  ...
  DelayCommand(1.0, SetIdentified(oObjetoCreado2, TRUE));
  DelayCommand(1.0, SetPlotFlag(oObjetoCreado2, TRUE));
  DelayCommand(1.0, SetStolenFlag(oObjetoCreado2, TRUE));
