...
if(i1 == 1)
{
DelayCommand(10.0,AssignCommand(oSacri,SpeakString("¡Yo no sirvo a Eilistrae!¡Esto es un error!")));
}
else if(i1 == 2)
{
DelayCommand(10.0,AssignCommand(oSacri,SpeakString("¡Arrepentíos! ¡No hagáis esto!")));
}
else if(i1 == 2)
{
DelayCommand(10.0,AssignCommand(oSacri,SpeakString("*Llora desconsoladamente, pues sabe lo que le va a pasar*")));
}
else
{
