void main()
{
   ...
   SetLocalString(oContenedor, "Res","semiorco");
   SetLocalString(oContenedor, "Raza","NW_CREATURE_004");
   location lSpawn = GetLocation(GetWaypointByTag("spawn_creatura"));
//   effect eVis = EffectVisualEffect(VFX_IMP_HEAD_ODD);
//   effect ePetrify = EffectParalyze();
   CreateObject(OBJECT_TYPE_CREATURE, "semiorco", lSpawn, FALSE);
   object oTarget = GetObjectByTag("NW_CREATURE_004");
