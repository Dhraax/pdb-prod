void main()
{
  // Bono dote soltura
  int iBono = 0;
  if(GetHasFeat(1243, GetPCSpeaker())) iBono = 10;      // Soltura epica
  else if(GetHasFeat(1228, GetPCSpeaker())) iBono = 3;  // Soltura normal

  string sTirada = "Escapismo";
  int iDado = Random(20)+1;
  int iRangos = GetSkillRank(32, GetPCSpeaker())+ iBono;
