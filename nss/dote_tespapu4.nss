//::///////////////////////////////////////////////
//:: TIRADOR DE LA ESPESURA: APUNTAR +4
//:: Copyright (c) www.puertadebladur.net
//:://////////////////////////////////////////////
/*
    +4 al ataque durante 1 minuto
...
{
  if(GetHasSpellEffect(872, OBJECT_SELF))
  {
...
void main()
{
  ...
  {
      FloatingTextStringOnCreature("<cþ<<>* Modo Apuntar desactivado *</c>", OBJECT_SELF, FALSE);
      RemoveEffectsFromSpell(OBJECT_SELF, 872);
      return;
  }
  ...
  effect eAtaque2 = ExtraordinaryEffect(EffectAttackIncrease(4));
