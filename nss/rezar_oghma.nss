...
//Todos los alineamientos permitidos.
  SetLocalInt(oPC, "REZAROGHMA", 1);
  DelayCommand(1440.0, DeleteLocalInt(oPC, "REZAROGHMA"));
  ...
  if(iProb <= 25 + iSab)
  {
      effect eEfecto1 = EffectSkillIncrease(SKILL_LORE,d10(1));
      ...
      DelayCommand(20.0, FloatingTextStringOnCreature("*¡Oghma te ha bendecido!*", oPC, FALSE));
      GiveXPToCreature(oPC,100);
      return;
  }
  else
  {
      DelayCommand(20.0, FloatingTextStringOnCreature("*Tus rezos no han llegado a Oghma.*", oPC, FALSE));
