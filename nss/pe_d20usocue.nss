void main()
{
  // Bono dote soltura
  int iBono = 0;
  if(GetHasFeat(1249, GetPCSpeaker())) iBono = 10;      // Soltura epica
  else if(GetHasFeat(1237, GetPCSpeaker())) iBono = 3;  // Soltura normal

  string sTirada = "Uso de cuerdas";
  int iDado = Random(20)+1;
  int iRangos = GetSkillRank(38, GetPCSpeaker()) + iBono;
