...
void main()
{
  ...
  int iDeseoPetrificar = ObtenerIntPersistente(oPC, "DESEO_PETRIFICAR");
  if(iDeseoPetrificar == 1)
  {
  ...
  AssignCommand(OBJECT_SELF, SpeakString("¿Vivir eternamente? ¡Como roca mucho aguantarás!"));

  GuardarIntPersistente(oPC, "DESEO_PETRIFICAR", 1);
  ...
  effect ePetrificar = EffectPetrify();
  DelayCommand(2.6, ApplyEffectToObject(DURATION_TYPE_TEMPORARY, ePetrificar, oPC, 1800.0));
