...
//:://////////////////////////////////////////////
//modificado para ropas reversibles
int StartingConditional()
{
    ...
    string sOut = "Coste: " + IntToString(iCost) + " monedas de oro.\n";
    sOut += "CA: " + IntToString(iAC) + "\n";
//    sOut += "(Nota: Sólo podrás copiar apariencias con el mismo valor de CA que tus ropas actuales.)\n";
    sOut += "¿Deseas continuar con la compra?";
