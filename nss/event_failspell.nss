...
void main()
{
    ...
    if (sCurrentEvent == "NWNX_ON_SPELL_FAILED_AFTER")
    {
        ...
        //SendMessageToPC(oPC,"Este es un mensaje de prueba para testear cuando un PJ ve fallado su conjuro, tu conjuro es el nº "+IntToString(iSpell)+" y tu clase lanzadora es "+IntToString(iClass)+".");
    }
}
