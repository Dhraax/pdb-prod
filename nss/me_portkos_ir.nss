void main()
{
object oBola1 = GetNearestObjectByTag("mebolanexo1");
object oBola2 = GetNearestObjectByTag("mebolanexo2");
object oBola3 = GetNearestObjectByTag("mebolanexo3");
object oBola4 = GetNearestObjectByTag("mebolanexo4");
object oBola5 = GetNearestObjectByTag("mebolanexo5");

object oWP = GetObjectByTag("WP_kossun_ida");
